...
\begin{tabular}{rl}
HTML5 & \progressbar[width=10em, borderwidth=0pt, ticksheight=0]{0.8} \\
CSS3	& \progressbar[width=10em, borderwidth=0pt, ticksheight=0]{0.7} \\
AngularJS	& \progressbar[width=10em, borderwidth=0pt, ticksheight=0]{0.7} \\
Apache Cordova	& \progressbar[width=10em, borderwidth=0pt, ticksheight=0]{0.6} \\
Ionic Framework	& \progressbar[width=10em, borderwidth=0pt, ticksheight=0]{0.6} \\
\end{tabular}
