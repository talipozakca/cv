...
\location{October 2015 -    | Istanbul, Turkey}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
  \item  \textbf IT Operations Analytics (ITOA)} Developing the new analytics solution of SAP for realtime log analysis for IT operations.
\end{tightitemize}
