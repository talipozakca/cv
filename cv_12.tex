...
\begin{tabular}{rl}
Java	 & \progressbar[width=7em, borderwidth=0pt, ticksheight=0]{0.3} \\
Javascript	 &  \progressbar[width=7em, borderwidth=0pt, ticksheight=0]{0.3} \\
\end{tabular}
...
\location{October 2014 -  | \.{I}stanbul, Turkey}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
\item \textbf{SAP IT Operations Analytics (ITOA):} Developing the new analytics solution of SAP for realtime log analysis
for IT operations
\end{tightitemize}
