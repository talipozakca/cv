...
\begin{entrylist}
  \entry
    ...
    {Software Developer}
    {SAP, Istanbul, Turkey}
    {I am part of a team which is responsible from software development with "Design Thinking" approach. I took part in several projects such as SAP Education Platform and SAP ITOA (IT Operation Analytics) and I was responsible from back-end and front-end development in different projects. I mostly used JavaScript and SAP Hana XSEngine for development. I also contributed in the data streaming part of the SAP ITOA project and used SAP Smart Streaming. I am currently a scrum master in our core development team which uses agile methodology for development.\\}
    {Keywords: Data Streaming, Java, Front-end Developer, JavaScript, Scrum Master}
  \entry
    {01/12 - 01/13}
