...
\begin{entrylist}
  \entry
    ...
    {SAP, Istanbul, Turkey}
    {
     ...
     \item \textbf{Streaming Engine:} Implementation of a streaming engine with using Golang, Kafka and Redis.
    ...
    \item \textbf{Keywords: Data Streaming, Java, GoLang, Front-end Developer, JavaScript, Scrum Master\\}
    }
  \entry
    {07/12 - 08/12 }
    {Intern}
